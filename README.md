...
notion-store-join-line is a Swift project for databases. It focuses on this technical goal: Develop a Swift command-oriented project for join scenarios with safe and unsafe fixtures, remediation hints, and single-node deterministic mode.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 168, risk penalty 6, latency penalty 3, and weight bonus 4. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
