"""Regression checks for the notion-store-join-line casebook."""
...
from casebook.harness import assert_expected, notion_store_join_line_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(notion_store_join_line_summary(), assert_expected())
