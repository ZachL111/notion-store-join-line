...
$repo = "notion-store-join-line"
$language = "Swift"
$category = "Databases"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/notion-store-join-walkthrough.md")) {
